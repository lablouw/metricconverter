...
import metricconverter.api.service.TestService;
...
public class TestServiceImpl implements TestService {
    ...
    public ResponseEntity<Response1> testGet1(@RequestBody Request1 apiRequest1) {
        metricconverter.domain.Request1 domainRequest1 = Request1Mapper.INSTANCE.toDomain(apiRequest1);

        metricconverter.domain.Response1 domainResponse1 = new metricconverter.domain.Response1(domainRequest1.getRequestString1(), domainRequest1.getRequestInt1());
    ...
    public ResponseEntity<Response2> testGet2(@RequestBody Request2 apiRequest2) {
        metricconverter.domain.Request2 domainRequest2 = Request2Mapper.INSTANCE.toDomain(apiRequest2);

        metricconverter.domain.Response2 domainResponse2 = new metricconverter.domain.Response2(domainRequest2.getRequestString2(), domainRequest2.getRequestInt2());
